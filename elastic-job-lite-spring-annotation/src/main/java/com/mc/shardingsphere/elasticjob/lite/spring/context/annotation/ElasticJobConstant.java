...
public interface ElasticJobConstant {
     ...
     */
    String ELASTIC_JOB_ANNOTATION_BEAN_PROCESS_NAME = "com.mc.shardingsphere.elasticjob.lite.spring.context.annotation.config.ElasticJobAnnotationBeanProcess";

    /**
     * 注册所有job的Bean Name
     */
    String ELASTIC_JOB_START_BEAN_NAME = "com.mc.shardingsphere.elasticjob.lite.spring.context.event.ElasticContextRefreshListener";
